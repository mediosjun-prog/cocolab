...
const GUIDES: GuideItem[] = [
 {
  ...
  {
    keywords: ['きょり', '関係', 'イメージ', '深層心理', '診断', 'チェック', '理解', 'ここきょり'],
    title: 'ここきょり',
    description: '「なぜか人と距離をとってしまう」「人間関係で疲れやすい」その背景にある心や特性の仕組みを優しく紐解きます。',
    url: '/kokodiagnosis',
  },
  {
    ...
    {
    keywords: ['過去', '親子', '深層心理', 'イメージ', 'ここあーと'],
    title: 'ここあーと',
  ...
  },
  {
    ...
    title: 'ここどう',
    description: '愛着スタイルの視点から二人の相互作用を紐解き、より良い未来へのヒントを見つけます。',
    url: '/kokodou',
  },
  {
