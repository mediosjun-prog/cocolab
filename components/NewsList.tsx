    ...
    <div className="bg-white p-4 rounded-2xl max-h-[250px] overflow-y-auto">
      ...
      <div className="py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 hover:bg-slate-50/50 transition-colors px-2 rounded-lg">
          <div className="flex items-center gap-3">
            <span className="text-xs text-slate-400">2026.09.19</span>
          <span className="text-xs bg-amber-100 text-amber-800 font-medium px-2 py-0.5 rounded">更新情報</span>
          </div>
          <Link href="/cases" className="text-slate-700 hover:text-[#5d8860] font-medium flex-1">
            事例更新しました。
          </Link>
        </div>
      ...
      <div className="py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 hover:bg-slate-50/50 transition-colors px-2 rounded-lg">
          ...
          <Link href="/kokotalk" className="text-slate-700 hover:text-[#5d8860] font-medium flex-1">
            こことーくを公開しました。
          </Link>
        </div>
      ...
      <div className="py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 hover:bg-slate-50/50 transition-colors px-2 rounded-lg">
        ...
        <div className="py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 hover:bg-slate-50/50 transition-colors px-2 rounded-lg">
          ...
          <Link href="/kokoart" className="text-slate-700 hover:text-[#5d8860] font-medium flex-1">
            ここあーとを公開しました。
          </Link>
        </div>
