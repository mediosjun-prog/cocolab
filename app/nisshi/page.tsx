...
export default function NisshiPage() {
  ...
  const [scoreData, setScoreData] = useState<{ percentage: number; message: string } | null>(null); // ← ここを追加！
  ...
  const handleSelectRecord = (record: NisshiRecord) => {
    ...
    setScoreData(record.scoreData || null); // 過去のスコアも復元
    setTab('create');
  };
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {tab === 'create' ? (
          <NisshiContent
            ...
            scoreData={scoreData} // ← NisshiContentへ渡す
