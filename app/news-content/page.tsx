    ...
    <div className="bg-white p-4 rounded-2xl">
      ...
      <div className="divide-y divide-slate-100 text-sm">
       ...
       <div className="py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 hover:bg-slate-50/50 transition-colors px-2 rounded-lg">
          ...
          <Link href="/kokodou" target="_parent" className="text-slate-700 hover:text-[#5d8860] font-medium flex-1">
            ここどうを公開しました。
          </Link>
        </div>
        ...
        <div className="py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 hover:bg-slate-50/50 transition-colors px-2 rounded-lg">
          ...
          <Link href="/kokomie" target="_parent" className="text-slate-700 hover:text-[#5d8860] font-medium flex-1">
            ここみえを公開しました。
          </Link>
        </div>
        ...
        <div className="py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 hover:bg-slate-50/50 transition-colors px-2 rounded-lg">
          ...
          <Link href="/kokosuki" target="_parent" className="text-slate-700 hover:text-[#5d8860] font-medium flex-1">
            ここすきを公開しました。
          </Link>
        </div>
        ...
        <div className="py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 hover:bg-slate-50/50 transition-colors px-2 rounded-lg">
          ...
          <Link href="/kokokoe" target="_parent" className="text-slate-700 hover:text-[#5d8860] font-medium flex-1">
            こここえを公開しました。
          </Link>
        </div>     
        ...
        <div className="py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 hover:bg-slate-50/50 transition-colors px-2 rounded-lg">
          ...
          <Link href="/kokoniwa" target="_parent" className="text-slate-700 hover:text-[#5d8860] font-medium flex-1">
        ...
        <div className="py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 hover:bg-slate-50/50 transition-colors px-2 rounded-lg">
          ...
          <Link href="/kokosure" target="_parent" className="text-slate-700 hover:text-[#5d8860] font-medium flex-1">
        ...
        <div className="py-3 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 hover:bg-slate-50/50 transition-colors px-2 rounded-lg">
          ...
          <Link href="/about" target="_parent" className="text-slate-700 hover:text-[#5d8860] font-medium flex-1">
